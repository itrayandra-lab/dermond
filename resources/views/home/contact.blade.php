    ...
    <div class="pt-28 pb-20 bg-gray-50 min-h-screen">
        <div class="container mx-auto px-6 md:px-8">
            ...
            <div class="text-center mb-12">
                <p class="text-xs font-bold tracking-widest text-primary uppercase mb-2">Hubungi Kami</p>
                <h1 class="text-4xl md:text-5xl font-display font-medium text-gray-900 mb-4">Kontak</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                    <h2 class="text-xl font-display font-medium text-gray-900 mb-6">Kirim Pesan</h2>

                    @if(session('success'))
                        <div class="mb-6 p-4 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-700 text-sm">
                            {{ session('success') }}
                        </div>
                    @endif
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="name"
                                    value="{{ old('name') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors @error('name') border-rose-300 @enderror"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="email"
                                    value="{{ old('email') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors @error('email') border-rose-300 @enderror"
                            ...
                            {{-- Subject --}}
                            <div>
                                <label for="subject" class="block text-xs font-medium text-gray-700 uppercase tracking-wider mb-2">
                                ...
                                <input
                                    ...
                                    name="subject"
                                    value="{{ old('subject') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors @error('subject') border-rose-300 @enderror"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    name="message"
                                    rows="5"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors resize-none @error('message') border-rose-300 @enderror"
                            ...
                            <button
                                type="submit"
                                class="w-full bg-primary hover:bg-primary/90 text-white font-medium py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                :disabled="loading"
                            >
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                        <h2 class="text-xl font-display font-medium text-gray-900 mb-6">Informasi Kontak</h2>
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $supportEmail }}" class="text-gray-900 hover:text-primary transition-colors">
                                        {{ $supportEmail }}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contactPhone) }}" target="_blank" class="text-gray-900 hover:text-primary transition-colors">
                                        {{ $contactPhone }}
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                        <h2 class="text-xl font-display font-medium text-gray-900 mb-6">Ikuti Kami</h2>
