        ...
        <div class="container mx-auto px-6 md:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <div class="space-y-6">
                    ...
                    {{-- Social Links Card --}}
                    @if($instagramUrl || $facebookUrl || $youtubeUrl || $tiktokUrl)
                    <div class="bg-dermond-card border border-white/10 p-6 md:p-8 rounded-2xl">
                        ...
                        <div class="flex gap-3">
                            ...
                            @if($tiktokUrl)
                            <a href="{{ $tiktokUrl }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 bg-black rounded-xl flex items-center justify-center hover:opacity-90 transition-opacity">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
