        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-dermond-card border border-white/10 rounded-2xl p-6 space-y-6">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    @else
                        <span class="text-sm text-red-400">Link pembayaran tidak tersedia. Silakan ulangi checkout.</span>
                    @endif
                </div>
                ...
                <p class="text-xs text-gray-500">
                    Kamu akan diarahkan ke halaman pembayaran Xendit. Jangan tutup halaman sampai transaksi selesai.
                </p>
            </div>
        </div>
    </div>
