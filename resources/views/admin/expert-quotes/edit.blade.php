...
<div class="section-container section-padding max-w-4xl mx-auto">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            <h1 class="text-3xl md:text-4xl font-display font-medium text-white">Edit Expert Quote</h1>
            <p class="mt-2 text-gray-400 font-light">Update the featured quote and author details.</p>
        </div>
    ...
    <div class="bg-dermond-card border border-white/10 p-8 rounded-2xl">
        @include('admin.expert-quotes._form', ['expertQuote' => $expertQuote])
    </div>
</div>
@endsection
